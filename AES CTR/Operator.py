...
from helper_crypto import encrypt_message_ec_ctr, decrypt_message_ec_ctr, generate_ecc_keys, derive_shared_secret
...
class Operator:
    ...
    def send_mission(self):
        while True:
            ...
            if mission.lower() == "logout":
                self.operator_socket.sendall(b"logout")
    ...
    def receive_ack(self):
        while True:
            ...
            print(f"Operator received acknowledgment from UAV: {decrypted_ack}")
